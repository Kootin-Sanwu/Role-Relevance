...
function generateApprovalLink($organizationEmail, $hashedPassword, $organizationName, $jobTitles, $organizationDescription)
{
    ...
    return "http://56.228.25.8/Local-Job-Role-Relevance-3/eStartup/assets/admin/approval.php?action=approve&token=$token";
}
...
function generateDeclineLink($organizationEmail)
{
    ...
    return "http://56.228.25.8/Local-Job-Role-Relevance-3/eStartup/assets/admin/approval.php?action=decline&token=$token";
}