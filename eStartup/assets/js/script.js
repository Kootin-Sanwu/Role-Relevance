...
async function fetchData_1() {
  try {
    ...
    const response = await fetch('http://56.228.25.8:5000/get_scores_1', {
      method: 'POST',
      headers: {
...
async function fetchData_2() {
  try {
    ...
    const response = await fetch('http://56.228.25.8:5000/get_scores_2', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
...
async function fetchData_3() {
  try {
    ...
    const response = await fetch('http://56.228.25.8:5000/get_scores_3', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
...
async function fetchData_4() {
  try {
    ...
    const response = await fetch('http://56.228.25.8:5000/get_scores_4', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
...
async function fetchData_5() {
  try {
    ...
    const response = await fetch('http://56.228.25.8:5000/get_scores_5', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
...
async function fetchData_6() {
  try {
    ...
    const response = await fetch('http://56.228.25.8:5000/get_scores_6', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
