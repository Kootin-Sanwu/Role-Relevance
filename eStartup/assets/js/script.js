...
async function fetchData_1() {
  try {
    ...
    const response = await fetch('http://51.20.4.204/get_scores_1', {
      method: 'POST',
      headers: {
...
async function fetchData_2() {
  try {
    ...
    const response = await fetch('http://51.20.4.204/get_scores_2', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
...
async function fetchData_3() {
  try {
    ...
    const response = await fetch('http://51.20.4.204/get_scores_3', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Organizationid': orgId // ✅ Send Org ID dynamically
